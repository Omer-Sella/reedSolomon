...
@author: Omer
"""
from binaryField import binaryFieldElement as galoisElement
from binaryField import polynomial as polynomialClass

def keyEquationSolver(polynomialClass, galoisElement, syndromes):
     # Key Equation Solver over an extension binary field
     L = 0
     cX = polynomialClass(coefficients = [1])
     pX = polynomialClass(coefficients = [1])
     l = 1
